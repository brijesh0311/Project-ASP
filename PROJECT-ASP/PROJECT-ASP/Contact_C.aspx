<%@ Page Title="" Language="C#" MasterPageFile="~/CLIENT_SIDE.Master" AutoEventWireup="true" CodeBehind="Contact_C.aspx.cs" Inherits="PROJECT_ASP.WebForm4" %>
            ...
            <div class="form-inner-cont mx-auto" style="max-width: 800px">
                    ...
                    <div class="row align-form-map">
                        ...
                        <div class="col-sm-6 form-input">
                            ...
                            <asp:TextBox ID="TextBox1" runat="server" name="w3lSender" placeholder="Email" required="" ></asp:TextBox>

                        </div>
                        <div class="col-sm-6 form-input">
                            <%--<input type="text" name="w3lSubect" placeholder="Subject" class="contact-input">--%>
                            <asp:TextBox ID="TextBox2" runat="server" name="w3lSubect" placeholder="Subject" class="contact-input"></asp:TextBox>

                        </div>
                        <div class="col-sm-6 form-input">
                            <%--<input type="number" name="w3lPhone" placeholder="Phone Number" class="contact-input">--%>
                            <asp:TextBox ID="TextBox3" runat="server" name="w3lPhone" placeholder="Phone Number" class="contact-input"></asp:TextBox>

                        </div>
                    </div>
                    <div class="form-input">
                        <%--<textarea placeholder="Message" name="w3lMessage" id="w3lMessage" required=""></textarea>--%>
                        <asp:TextBox ID="TextBox4" runat="server" placeholder="Message" name="w3lMessage" required=""></asp:TextBox>
                    ...
                    <div class="submit text-right">
                        <%--<button type="submit" class="btn btn-style">
                            Submit
                            Message</button>--%>
                        <asp:Button ID="Button1" runat="server" Text="Submit Message" class="btn btn-style" Width="250px" />
